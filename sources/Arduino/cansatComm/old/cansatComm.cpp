...
cansatComm::cansatComm(uint8_t id,uint8_t devices) : _date_millis(0), _tempBMP085(0), _pressure(0), _tempDHT22(0), _humidity(0), _xaxis(0), _yaxis(0), _zaxis(0), _NMEAdata(0)
{
	_headerdat[0] = 0x10;
	_headerdat[1] = 0x65;
	_headerdat[2] = 0x07;
